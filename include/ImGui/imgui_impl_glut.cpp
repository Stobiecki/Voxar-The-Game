...
{
        //glutReshapeFunc(ImGui_ImplGLUT_ReshapeFunc);// felerna linijka! :<
...
void ImGui_ImplGLUT_UpdateKeyModifiers()
{
    ImGuiIO& io = ImGui::GetIO();
...
void ImGui_ImplGLUT_AddKeyEvent(ImGuiKey key, bool down, int native_keycode)
{
    ImGuiIO& io = ImGui::GetIO();
